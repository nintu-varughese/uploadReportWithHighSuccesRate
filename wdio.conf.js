...
let tmpFilesPath = path.resolve('./test/.artifacts');
let downloadsFolder = path.resolve(tmpFilesPath, 'downloads');
// let failedCount = 0;
...
exports.config = {
    ...
    afterTest: async function (test, context, {error, result, duration, passed, retries}) {
        ...
        //  allureReporter.addAttachment(`${apiCalls.calls[key].method} : ${apiCalls.calls[key].url}`, `${logInfo}`); // Attach the API logs into allure reporter
        // });
    },
